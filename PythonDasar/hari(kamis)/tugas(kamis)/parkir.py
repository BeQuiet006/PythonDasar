...
class ParkirApp:
    def __init__(self, root):
        ...
        self.listbox_pelanggan = tk.Listbox(self.frame_pelanggan)
        self.listbox_pelanggan.pack()
    ...
    def cari_pelanggan(self):
        ...
        # Lakukan pencarian data pelanggan berdasarkan nomor polisi/nopol di database atau list pelanggan
        
        # Jika pelanggan ditemukan, tampilkan data di entry masuk, keluar, dan biaya
