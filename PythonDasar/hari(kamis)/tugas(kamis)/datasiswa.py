...
# Tombol Hapus
hapus_button = Button(tombol_frame, text="Hapus", bg="orange", command=hapus)
hapus_button.grid(row=0, column=0)

# Tombol Simpan
simpan_button = Button(tombol_frame, text="Simpan", bg="orange", command=simpan)
simpan_button.grid(row=-0, column=0)
